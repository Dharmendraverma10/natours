...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGhhcm1lbmRyYXZlcm1hIiwiYSI6ImNrY3c0NTkzbDBhaWIzMHMxNGs5MDFtd2oifQ.qnJuPDVADN0DJGC0V_pJGw';
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status === 'success') location.reload(true); //if (res.data.status === 'success') location.assign('/');
...
var stripe = Stripe('pk_test_51H9Y6SIb3mPgI1NMbpC0tN2EQqBYg3jXjKJk8jPLoACh0v6t2JNJZNbEkhZttbcYlG4sgwQC46yNYUSqQ4cQeKJi007kMgNBZJ');
  ...
  regeneratorRuntime.mark(function _callee(e) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault(); //document.querySelector('.btn--save-data').textContent = 'Updating...';
